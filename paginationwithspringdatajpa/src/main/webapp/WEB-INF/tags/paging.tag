...
<script
	src="http://maxcdn.bootsrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
...
<c:if test="${pagedListHolder.pageCount > 1 }">
	<ul class="pagination">
		...
		<c:if test="${pagedListHolder.firstPage > 0 }">
			<li><a href="<%=StringUtils.replace(pagedLink, "~", "0")%>"></a>1</li>
		</c:if>
